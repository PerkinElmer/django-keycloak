...
class Users(KeycloakAdminBase):
    ...
    def create(self, username, **kwargs):
        ...
        for key in USER_KWARGS:
            from django_keycloak.python_keycloak_client.admin.clientroles import to_camel_case
            if key in kwargs:
...
class User(KeycloakAdminBase):
    ...
    def role_mappings(self):
        from django_keycloak.python_keycloak_client.admin.user.userroles import UserRoleMappings
    ...
    @property
    def groups(self):
        from django_keycloak.python_keycloak_client.admin.user.usergroup import UserGroups
